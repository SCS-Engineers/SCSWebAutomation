...
test.describe('SCS Site Status Dashboard Tests', () => {
  ...
  test('DS-SITE-STATUS-03 - Verify Site Contacts popup column headers', async ({ page }) => {
    ...
    const { contactIconClass, expectedPopupTitle, dataApproversColumns, usersWithAccessColumns, contactsColumns, tabLabels } = testData.testData.siteStatusDashboard;
  ...
  test('DS-SITE-STATUS-15 - Verify Reading Approval Required count equals sum of LFG Data presets', async ({ page }) => {
    ...
    const { count: readingApprovalRequiredCount, siteName, row: targetRow, colIndex: readingApprovalColIndex } = await siteStatusDashboardPage.findRowWithCountInColumn('Reading Approval Required', 0);
  ...
  test('DS-SITE-STATUS-23 - Verify clicking on Sample Ports Not Monitored column navigates to Point Specific Monitoring Report', async ({ page }) => {
    ...
    const { siteName: savedSiteName, row: targetRow, colIndex: samplePortsColIndex } = 
      await siteStatusDashboardPage.findFirstCellWithValueInColumn('Sample Ports Not Monitored');
  ...
  test('DS-SITE-STATUS-25 - Verify clicking on Flr-Eng-GHG Not Monitored column navigates to Point Specific Monitoring Report', async ({ page }) => {
    ...
    const { siteName: savedSiteName, row: targetRow, colIndex: flrEngGHGColIndex } = 
      await siteStatusDashboardPage.findFirstCellWithValueInColumn('Flr-Eng-GHG Not Monitored');
  ...
  test('DS-SITE-STATUS-27 - Verify clicking on Missed Readings column navigates to Missed Readings page', async ({ page }) => {
    ...
    const { siteName: savedSiteName, row: targetRow, colIndex: missedReadingsColIndex } = 
      await siteStatusDashboardPage.findFirstCellWithValueInColumn('Missed Readings');
